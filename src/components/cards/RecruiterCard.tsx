...
export function RecruiterCard({ initials, name, title, bio, email }: RecruiterCardProps) {
  return (
    <article className="bg-white border border-border rounded-none p-8 flex flex-col items-center text-center gap-4 transition-all duration-200 hover:-translate-y-2 hover:shadow-xl">

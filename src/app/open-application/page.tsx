              ...
              <div className="bg-white border border-border rounded-3xl p-12">
                ...
                <form className="flex flex-col gap-6" onSubmit={(e) => { e.preventDefault(); setSubmitted(true); }}>
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <input id="oa-email" type="email" required autoComplete="email" placeholder="sarah@example.com" className="h-12 px-4 rounded-lg border-[1.5px] border-border focus:border-amber focus:outline-none text-sm transition-colors" />
                  </div>
                  <div className="flex flex-col gap-2">
                    <label htmlFor="oa-phone" className="text-sm font-semibold text-text-primary">Phone <span className="text-red-500">*</span></label>
                    <input id="oa-phone" type="tel" required autoComplete="tel" placeholder="+31 6 …" className="h-12 px-4 rounded-lg border-[1.5px] border-border focus:border-amber focus:outline-none text-sm transition-colors" />
                  </div>
                  {[
                    ...
                    <div key={id} className="flex flex-col gap-2">
                      ...
                      <select id={id} required className="h-12 px-4 rounded-lg border-[1.5px] border-border focus:border-amber focus:outline-none text-sm transition-colors appearance-none bg-white"
                  ...
                  <div className="flex flex-col gap-2">
                    ...
                    <textarea id="oa-notes" rows={3} className="px-4 py-3 rounded-lg border-[1.5px] border-border focus:border-amber focus:outline-none text-sm transition-colors resize-y" placeholder="Salary expectations, types of roles you're interested in, any constraints…" />
                  </div>
                  <button type="submit" className="w-full h-12 bg-amber text-navy font-semibold rounded-full hover:scale-[1.02] hover:shadow-md transition-all">Register my profile →</button>
